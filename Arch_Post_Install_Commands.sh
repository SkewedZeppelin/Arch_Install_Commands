...
sudo pacman -S --needed android-tools audacity bc bleachbit checksec cheese chromium clamav conky cpupower eclipse empathy eog evince evolution filezilla freerdp gcc-multilib gedit gimp git gksudo gnome-calculator gnome-calendar gnome-disk-utility gnome-keyring gnome-screenshot gnome-sound-recorder gnome-system-log gnome-system-monitor gradm gst-libav gtkmm hexchat htop intellij-idea-community-edition jdk7-openjdk jdk8-openjdk jre7-openjdk jre7-openjdk-headless jre8-openjdk jre8-openjdk-headless keepass lib32-alsa-plugins lib32-readline libreoffice-fresh linux-grsec linux-headers mumble numix-themes parted pax-utils paxd paxtest perl-switch proguard python python-pip python2-virtualenv remmina rhythmbox schedtool seahorse squashfs-tools steam telepathy-gabble telepathy-idle telepathy-rakia telepathy-salut totem transmission-gtk vlc wget wireshark-cli wireshark-gtk xfce4-terminal zip #Install official applications
